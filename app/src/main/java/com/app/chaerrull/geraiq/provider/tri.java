...
public class tri extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loading = ProgressDialog.show(tri.this,
                null,
                "Please wait...",
                true,
                false);

        database.child("tri").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                 ...
                 */
                requestAdapterRecyclerView = new RequestAdapterRecyclerView(daftarReq, tri.this);

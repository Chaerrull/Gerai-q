...
public class indosat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loading = ProgressDialog.show(indosat.this,
                null,
                "Please wait...",
                true,
                false);

        database.child("indosat").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                 ...
                 */
                requestAdapterRecyclerView = new RequestAdapterRecyclerView(daftarReq, indosat.this);

...
public class smartfren extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loading = ProgressDialog.show(smartfren.this,
                null,
                "Please wait...",
                true,
                false);

        database.child("smart").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                 ...
                 */
                requestAdapterRecyclerView = new RequestAdapterRecyclerView(daftarReq, smartfren.this);

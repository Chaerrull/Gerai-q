...
public class telkomsel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loading = ProgressDialog.show(telkomsel.this,
                null,
                "Please wait...",
                true,
                false);

        database.child("Telkomsel").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                 ...
                 */
                requestAdapterRecyclerView = new RequestAdapterRecyclerView(daftarReq, telkomsel.this);
